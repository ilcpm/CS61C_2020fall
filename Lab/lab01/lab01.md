> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [web.archive.org](https://web.archive.org/web/20220121183640/https://inst.eecs.berkeley.edu/~cs61c/fa20/labs/lab01/#setup)
...
For this exercise, you will find the [GDB reference card useful](https://web.archive.org/web/20220121183640/https://inst.eecs.berkeley.edu/~cs61c/sp21/resources-pdfs/gdb5-refcard.pdf). GDB stands for “GNU De-Bugger.” Compile `hello.c` with the `-g` flag:
